...
def create_word_cloud(f):
    ...
    wc = WordCloud(
        font_path='/anaconda3/lib/python3.7/site-packages/matplotlib/mpl-data/fonts/ttf/SimHei.ttf',
        max_words=100,
        width=2000,
        height=1200
    )
    ...
    # 写词云图片
    wordcloud.to_file("wangyiyun.jpg")
    # 显示词云文件
...
# 得到指定歌手页面 热门前 50 的歌曲名
def get_songs(artist_id):
    page_url = 'http://music.163.com/artist?id=' + artist_id
    # 获取网页 HTML
